...
extension Clients {
  ...
  class AssuredWorkloadsServiceTransport: AssuredWorkloadsServiceStub {
    let inner: GoogleCloudGax.HTTPClient

    public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
      self.inner = try GoogleCloudGax.HTTPClient(
        from: options, withDefaultEndpoint: "https://assuredworkloads.googleapis.com")
    }
    ...
    public func restrictAllowedResources(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0):restrictAllowedResources"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
